...
```
<sup><a href='/ApprovalTests/integrations/catch/Catch2Approvals.h#L15-L17' title='File snippet `required_header_for_catch` was extracted from'>snippet source</a> | <a href='#snippet-required_header_for_catch' title='Navigate to start of snippet `required_header_for_catch`'>anchor</a></sup>
<!-- endsnippet -->
