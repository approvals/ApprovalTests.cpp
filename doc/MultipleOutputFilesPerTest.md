...
```
<sup>[snippet source](/tests/ApprovalTests_DocTest_Tests/DocTestDocumentationSamples.cpp#L60-L77) / [anchor](#snippet-doctest_multiple_output_files_hard_coded)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/tests/ApprovalTests_DocTest_Tests/DocTestDocumentationSamples.cpp#L79-L93) / [anchor](#snippet-approvals_multiple_output_files_dynamic)</sup>
<!-- endsnippet -->
...
```
<sup>[snippet source](/tests/ApprovalTests_DocTest_Tests/DocTestDocumentationSamples.cpp#L95-L112) / [anchor](#snippet-approvals_multiple_output_files_hard_coded)</sup>
<!-- endsnippet -->
