...
In this case, you will need to disable the compilation check of `__FILE__`, which can be done by defining the `APPROVALTESTS_DISABLE_FILE_MACRO_CHECK` macro. This can be done line this:
