...
```
<sup><a href='/ApprovalTests/Approvals.h#L202-L204' title='File snippet `customising_to_string_default_converter` was extracted from'>snippet source</a> | <a href='#snippet-customising_to_string_default_converter' title='Navigate to start of snippet `customising_to_string_default_converter`'>anchor</a></sup>
<!-- endsnippet -->
