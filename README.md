...
:arrow_down: <a href="https://github.com/approvals/ApprovalTests.cpp/releases/download/v.10.5.0/ApprovalTests.v.10.5.0.hpp">Download the latest version (v.10.5.0) of the **single header file** here.</a>
